...
import DoctorCard from "@/Components/GenericComponents/DoctorCard";

const SimilarDoctorsProfile: React.FC = () => {
  const doctors = [
    {
      id :1,
  ...
  return (
    <div className = "mt-20 m-10">
             <h1 className = "font-lato text-3xl text-darkCustomBlue leading-custom-30 font-extrabold pb-20"> Other Recommended experts</h1>
...
export default SimilarDoctorsProfile;
